...
//----宏定义OLED引脚----	 
#define  OLED_SCL_PIN	SCREEN_SCL_PIN
#define  OLED_SDA_PIN	SCREEN_SDA_PIN
#define  OLED_RST_PIN	SCREEN_RST_PIN
#define  OLED_DC_PIN	SCREEN_DC_PIN
#define  OLED_CS_PIN	SCREEN_CS_PIN
